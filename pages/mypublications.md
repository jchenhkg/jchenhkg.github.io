...
* Ho Yin Au, **Jie Chen**, Junkun Jiang, Yike Guo, "ChoreoGraph: Music-conditioned Automatic Dance Choreography over a Style and Tempo Consistent Dynamic Graph," accepted by _ACM International Conference on Multimedia_ **(ACM MM)**, 2022
* Junkun Jiang, **Jie Chen**, Yike Guo, "A Dual-Masked Auto-Encoder for Robust Motion Capture with Spatial-Temporal Skeletal Token Completion," accepted by _ACM International Conference on Multimedia_ **(ACM MM)**, 2022
